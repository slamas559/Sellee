...
export function ProductReviewsSection({
  ...
  // Reviews are read-only on the product page; posting is restricted to
  // verified purchasers via server APIs. This component only displays
  // a small sample of reviews for the product.
  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      {/* Posting reviews is disabled on the product page; only verified purchasers with delivered orders may submit reviews through the server-side flow. */}
