    ...
    <div className="relative h-full w-full overflow-hidden">
              ...
              <Popup>
                <div className="p-3">
                  ...
                  <Link
                    ...
                    className="mt-3 flex items-center justify-center rounded-xl bg-emerald-600 px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-emerald-700"
                  >
                    Visit store
                  </Link>
                </div>
      ...
      {showSearchArea ? (
        <button
          ...
          className="absolute left-1/2 top-24 z-[1000] flex -translate-x-1/2 items-center gap-1.5 rounded-full bg-slate-900 px-4 py-2 text-xs font-semibold text-white shadow-lg transition hover:bg-slate-800 sm:top-20"
        >
        ...
        <div className="rounded-2xl border border-white/60 bg-white/95 p-2.5 shadow-xl shadow-slate-300/40 backdrop-blur">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white text-emerald-700 transition hover:bg-emerald-50 disabled:opacity-50"
            >
