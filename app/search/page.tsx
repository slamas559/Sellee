      ...
      <header className="rounded-3xl border border-emerald-100 bg-white p-5 shadow-sm sm:p-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-black tracking-tight text-slate-900">Search Results</h1>
            {state.q ? <p className="mt-1 text-sm text-slate-600">Results for "{state.q}"</p> : null}
          </div>
